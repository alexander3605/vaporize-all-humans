...
from external.lama.saicinpainting.training.modules.ffc import FFCResNetGenerator
from external.lama.saicinpainting.training.modules.pix2pixhd import GlobalGenerator, MultiDilatedGlobalGenerator, \
